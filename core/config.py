...
class DatabaseConfig:
    ...
    user: str = field(default_factory=lambda: os.getenv("POSTGRES_USER", "regimeiq"))
    password: str = field(default_factory=lambda: os.getenv("POSTGRES_PASSWORD", "regimeiq"))
    database: str = field(default_factory=lambda: os.getenv("POSTGRES_DB", "regimeiq"))
