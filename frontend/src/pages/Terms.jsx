...
export default function Terms() {
  return (
    <LegalPage title="Terms of Service" lastUpdated="May 6, 2026">
      <p>
        By using VektorLabs, you agree to these terms. Please read them carefully.
      </p>
      <h2>Use of Service</h2>
      <p>
        VektorLabs provides market intelligence and analytical tools. The service is intended for
        informational purposes only and does not constitute financial advice.
      </p>
      <h2>Account Responsibilities</h2>
      <ul>
        <li>You are responsible for maintaining the security of your account credentials</li>
        <li>You may not share your account or beta access codes without permission</li>
        <li>You may not use the service for any unlawful purpose</li>
      </ul>
      <h2>No Financial Advice</h2>
      <p>
        VektorLabs is an analytical platform. Nothing on this platform constitutes financial,
        investment, legal, or tax advice. Always do your own research before making trading decisions.
      </p>
      <h2>Subscriptions & Payments</h2>
      <p>
        Subscriptions are billed monthly. Cancellations take effect at the end of the current
        billing period. No refunds are issued for partial periods.
      </p>
      <h2>Service Availability</h2>
      <p>
        We aim for high availability but do not guarantee uninterrupted access. We are not liable
        for any losses resulting from service downtime or data inaccuracies.
      </p>
      <h2>Contact</h2>
      <p>
        For terms inquiries, contact us via Discord or the email on our website.
      </p>
    </LegalPage>
  );
}