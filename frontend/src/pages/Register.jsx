  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .reg-card-enter { animation: fadeUp 0.5s cubic-bezier(0.16, 1, 0.3, 1) forwards; }
        .reg-grid-bg {
        ...
        .reg-glow { animation: pulse-glow 4s ease-in-out infinite; }
      `}</style>

      <div className="reg-grid-bg" style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }} />
      <div className="reg-glow" style={{
      ...
      <div style={{
        ...
        <div className="reg-card-enter" style={{ width: '100%', maxWidth: '420px' }}>
          {/* Logo */}
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontFamily: C.mono, fontSize: '10px', color: C.accent, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
